...
import { IoEye, IoHeart, IoList, IoFilterOutline, IoTimeSharp, IoHeartOutline, IoBookmark, IoBookmarkOutline, IoDownload } from "react-icons/io5";
...
const GraphicsPage = () => {
  ...
  const filteredItems = useMemo(() => {
    return graphics.filter((item: Resource) => {
  ...
  }, [graphics, activeFilters, searchQuery]);
            ...
            <div className={viewMode === 'grid' ? classes.grid : classes.listView}>
              {displayedItems.length === 0 ? (
                <div className={classes.emptyState}>
                  <FaPalette />
                  <p>ไม่พบกราฟิกที่ตรงกับเงื่อนไขการค้นหา</p>
                </div>
              ) : (
                <>
                      ...
                      <div className={classes.cardInfo} style={{borderRadius: '16px', boxShadow: 'none', padding: '5px 9px', margin: '5x 5px 0 8px'}}>
                        ...
                        <div className={classes.stats} style={{gap: '14px'}}>
                          <span className="stat" style={{color: '#94a3b8', fontSize: '0.92rem', fontWeight: 400}}>
                            ...
                            {(likeCounts[item.id] || 0) + (item.downloadCount || 0)}
                          </span>
                          <span className="stat" style={{color: '#94a3b8', fontSize: '0.92rem', fontWeight: 400}}>
