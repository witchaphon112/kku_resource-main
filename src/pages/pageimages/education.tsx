...
const PageEducation = () => {
  ...
  const educationImages = resourcesData.resources.filter(
    (r) => r.category === "education" && r.type === "image"
  );

  return (
    <div className="p-4">
      <h2 className={classes.title}>หมวดหมู่การเรียนการสอน</h2>
      <div className={classes.grid}>
        {educationImages.map((item) => (
          <div
            key={item.id}
