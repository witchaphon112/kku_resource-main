...
import { FaHeart, FaUniversity, FaBook, FaThLarge, FaRegBookmark, FaDownload, FaEye, FaFilter, FaSpinner, FaTimes, FaUser, FaFileAlt, FaImage, FaSort, FaCheck, FaList, FaTrophy, FaFolder, FaCode, FaGlobe, FaUndo, FaChevronDown, FaChevronLeft, FaChevronRight, FaTags, FaRegHeart, FaPalette, FaClock, FaPlay } from "react-icons/fa";
import { BiFilterAlt } from 'react-icons/bi';
import { MdFilterList, MdFilterAlt } from 'react-icons/md';
import { IoEye, IoHeart, IoList, IoFilterOutline, IoTimeSharp, IoBookmark, IoBookmarkOutline, IoHeartOutline } from "react-icons/io5";
...
const VideosPage = () => {
  ...
  const filteredItems = useMemo(() => {
    return videos.filter((item: Resource) => {
  ...
  }, [videos, activeFilters, searchQuery]);
  ...
  const mockTags = [
    "การแพทย์", "การเรียนการสอน", "มหาวิทยาลัย", "เรียนต่อ",
    "สุขภาพ", "กราฟฟิก", "ผลงาน", "โรงพยาบาล", "AI", "IT"
  ];
            ...
            <div className={viewMode === 'grid' ? classes.grid : classes.listView}>
              {displayedItems.length === 0 ? (
                <div className={classes.emptyState}>
                  <FaImage />
                  <p>ไม่พบวิดีโอที่ตรงกับเงื่อนไขการค้นหา</p>
                </div>
              ) : (
                <>
