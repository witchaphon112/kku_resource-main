          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className={classes.filterSection}>
              ...
              <div className={classes.typeGrid}>
                <button
                  type="button"
                  className={`${classes.typeButton} ${types.includes("all") ? classes.typeButtonActive : ''}`}
                  onClick={() => handleTypeChange("all")}
                >
                  {types.includes("all") && <FaCheck className={classes.checkIcon} />}
                  ทั้งหมด
                </button>
                {resourceTypes.filter(type => type !== "all").map(type => (
                  ...
                  >
                    ...
                    {type === "medical" ? "การแพทย์" : 
                     type === "education" ? "การศึกษา" : 
                     type === "campus" ? "รอบรั้ว" : type}
                  </button>
                ))}
              </div>
            </div>
