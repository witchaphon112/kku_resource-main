...
import {
  ...
  InfoCircleIcon,
  TimesCircleIcon
} from "./chunk-Q4XZHUAK.js";
import {
  Button
} from "./chunk-O5S5N2NS.js";
import {
  CheckIcon
} from "./chunk-V6VEIW7D.js";
import "./chunk-NGSRPLDH.js";
import "./chunk-TUEB2YEO.js";
import {
  TimesIcon
} from "./chunk-PKWEU3U3.js";
import {
  CSSTransition,
  TransitionGroup_default
} from "./chunk-3UCG3WIK.js";
import "./chunk-LGTN4NXF.js";
import "./chunk-RMS54SXL.js";
import "./chunk-SFL2VBZV.js";
import {
  IconBase
} from "./chunk-QDWSQBDM.js";
import {
  Ripple
} from "./chunk-M53VTQ6O.js";
...
var ProgressBar = React4.memo(React4.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  ...
  var createDeterminate = function createDeterminate2() {
    ...
    return React4.createElement("div", _extends4({
      id: props.id,
      ref: elementRef
    }, rootProps), React4.createElement("div", valueProps, label != null && React4.createElement("div", labelProps, label)));
  };
  var createIndeterminate = function createIndeterminate2() {
    ...
    return React4.createElement("div", _extends4({
      id: props.id,
      ref: elementRef
    }, rootProps), React4.createElement("div", containerProps, React4.createElement("div", valueProps)));
  };
...
var FileUpload = React5.memo(React5.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React5.useContext(PrimeReactContext);
  var props = FileUploadBase.getProps(inProps, context);
  var _React$useState = React5.useState([]), _React$useState2 = _slicedToArray2(_React$useState, 2), uploadedFilesState = _React$useState2[0], setUploadedFilesState = _React$useState2[1];
  var _React$useState3 = React5.useState([]), _React$useState4 = _slicedToArray2(_React$useState3, 2), filesState = _React$useState4[0], setFilesState = _React$useState4[1];
  var _React$useState5 = React5.useState(0), _React$useState6 = _slicedToArray2(_React$useState5, 2), progressState = _React$useState6[0], setProgressState = _React$useState6[1];
  ...
  var _React$useState9 = React5.useState(false), _React$useState10 = _slicedToArray2(_React$useState9, 2), uploadingState = _React$useState10[0], setUploadingState = _React$useState10[1];
  var metaData = {
    props,
    state: {
  ...
  var fileInputRef = React5.useRef(null);
  var messagesRef = React5.useRef(null);
  var contentRef = React5.useRef(null);
  var uploadedFileCount = React5.useRef(0);
  ...
  var createChooseButton = function createChooseButton2() {
    ...
    var label = iconOnly ? React5.createElement("span", _extends5({}, chooseButtonLabelProps, {
      dangerouslySetInnerHTML: {
        __html: "&nbsp;"
      }
    })) : React5.createElement("span", chooseButtonLabelProps, chooseButtonLabel);
    ...
    var input = React5.createElement("input", inputProps);
    ...
    var icon = _icon || React5.createElement(PlusIcon, chooseIconProps);
    ...
    return React5.createElement("span", chooseButtonProps, input, chooseIcon2, label, React5.createElement(Ripple, null));
  };
  ...
  var createFile = function createFile2(file, index, badgeOptions) {
    ...
    var preview = isImage(file) ? React5.createElement("img", _extends5({}, thumbnailProps, {
      alt: file.name
    })) : null;
    ...
    var fileName = React5.createElement("div", fileNameProps, file.name);
    var size = React5.createElement("div", fileSizeProps, formatSize(file.size));
    var contentBody = React5.createElement("div", detailsProps, React5.createElement("div", fileNameProps, " ", file.name), React5.createElement("span", fileSizeProps, formatSize(file.size)), React5.createElement(Badge, {
    ...
    var removeButton = React5.createElement("div", actionsProps, React5.createElement(Button, {
      type: "button",
      icon: props.removeIcon || React5.createElement(TimesIcon, null),
      text: true,
      rounded: true,
      severity: "danger",
    ...
    var content = React5.createElement(React5.Fragment, null, preview, contentBody, removeButton);
    ...
    return React5.createElement("div", fileProps, content);
  };
  var createFiles = function createFiles2() {
    ...
    return React5.createElement("div", null, content);
  };
  ...
  var createProgressBarContent = function createProgressBarContent2() {
    ...
    return React5.createElement(ProgressBar, {
      value: progressState,
      showValue: false,
      pt: ptm("progressbar"),
      __parentMetadata: {
  ...
  var createAdvanced = function createAdvanced2() {
    ...
    if (!props.auto) {
      ...
      var uploadIcon2 = IconUtils.getJSXIcon(uploadOptions.icon || React5.createElement(UploadIcon, uploadIconProps), _objectSpread3({}, uploadIconProps), {
        props
      });
      ...
      var cancelIcon2 = IconUtils.getJSXIcon(cancelOptions.icon || React5.createElement(TimesIcon, cancelIconProps), _objectSpread3({}, cancelIconProps), {
        props
      });
      uploadButton = React5.createElement(Button, {
        type: "button",
        label: uploadLabel,
        "aria-hidden": "true",
        icon: uploadIcon2,
      ...
      cancelButton = React5.createElement(Button, {
        type: "button",
        label: cancelLabel,
        "aria-hidden": "true",
        icon: cancelIcon2,
    ...
    var header = React5.createElement("div", buttonbarProps, chooseButton2, uploadButton, cancelButton);
    ...
    return React5.createElement("div", rootProps, header, React5.createElement("div", contentProps, progressBar, React5.createElement(Messages, {
      ref: messagesRef,
      __parentMetadata: {
        parent: metaData
      }
  ...
  var createBasic = function createBasic2() {
    ...
    var chooseLabel = chooseOptions.iconOnly ? React5.createElement("span", _extends5({}, labelProps, {
      dangerouslySetInnerHTML: {
        __html: "&nbsp;"
      }
    })) : React5.createElement("span", labelProps, chooseButtonLabel);
    var label = props.auto ? chooseLabel : React5.createElement("span", labelProps, hasFiles ? props.selectedFileLabel || filesState[0].name : chooseLabel);
    var chooseIconProps = mergeProps({
      className: cx("chooseIcon", {
        iconOnly: chooseOptions.iconOnly
      })
    }, ptm("chooseIcon"));
    var icon = chooseOptions.icon ? chooseOptions.icon : !chooseOptions.icon && (!hasFiles || props.auto) ? React5.createElement(PlusIcon, chooseIconProps) : !chooseOptions.icon && hasFiles && !props.auto && React5.createElement(UploadIcon, chooseIconProps);
    var chooseIcon2 = IconUtils.getJSXIcon(icon, _objectSpread3({}, chooseIconProps), {
      props,
      hasFiles
    });
    ...
    var input = !hasFiles && React5.createElement("input", inputProps);
    var rootProps = mergeProps({
      className: classNames(props.className, cx("root")),
      style: props.style
    }, FileUploadBase.getOtherProps(props), ptm("root"));
    ...
    return React5.createElement("div", rootProps, React5.createElement(Messages, {
      ref: messagesRef,
      pt: ptm("message"),
      __parentMetadata: {
        parent: metaData
      }
    }), React5.createElement("span", basicButtonProps, chooseIcon2, label, input, React5.createElement(Ripple, null)));
  };
  if (props.mode === "advanced") {
